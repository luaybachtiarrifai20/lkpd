...
export type PBLStep = {
  ...
  ringkas: string;
  blocks: ContentBlock[];
  /** Opsional: tautan YouTube / website / gambar di level sintaks */
  mediaUrl?: string;
...
export type ContentBlock =
  ...
  | {
      ...
      title: string;
      kiri: { label: string; deskripsi: string };
      kanan: { label: string; deskripsi: string };
    }
  | {
  ...
  | {
      ...
      id: string;
      title: string;
      options: { id: string; label: string; deskripsi: string }[];
      alasanId: string;
    }
  ...
  | {
      ...
      simbolik: string;
      levels?: { title: string; desc: string; color?: string }[];
    };
